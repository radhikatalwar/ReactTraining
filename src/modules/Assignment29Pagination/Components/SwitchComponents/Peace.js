...
export const Peace = () => {
  ...
  useEffect(() => {
    dispatch(fetchdataSpecific("peace"));
  }, []);
  ...
  return (
    <div className={classes.container}>
      <img
        ...
        src="https://www.brainyquote.com/photos_tr/en/c/carlossantana/179044/carlossantana1.jpg"
        alt="quote"
      />
      <Typography className={classes.heading}>{"Peace Quotes"}</Typography>
